...
PORT_SENSOR = 9300          # Device node communication port (formerly 3000)
PORT_ANDROID = 9301         # Mobile application communication port (formerly 3001)
PORT_DB_SERVER = 9302       # Database server communication port (formerly 5000)

# Message terminator (all TCP messages are delimited by \n)
MSG_TERMINATOR = "\n"
