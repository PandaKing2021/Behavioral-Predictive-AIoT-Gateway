...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_Back_to_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(RegisterActivity.this,"Left Register Page",Toast.LENGTH_SHORT).show();
    ...
    protected int register() {
        int state = 0;
        try {
            // Read user config key-value pairs from assets folder
            ...
            if (device_key.equals(""))
                device_key = "NULL";  // Force-fill the field
