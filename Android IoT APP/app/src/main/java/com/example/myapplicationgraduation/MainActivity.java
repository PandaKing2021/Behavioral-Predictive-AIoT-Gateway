    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_AirConditioner_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MainActivity.this,"Navigating to Smart AC Details",Toast.LENGTH_LONG).show();
        ...
        b_Curtain_detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this,"Navigating to Smart Curtain Details",Toast.LENGTH_LONG).show();
        ...
        b_Door_security_detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this,"Navigating to Smart Door Security Details",Toast.LENGTH_LONG).show();
        ...
        b_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this,"Navigating to History Details",Toast.LENGTH_LONG).show();
